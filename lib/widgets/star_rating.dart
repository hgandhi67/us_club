...
typedef RatingChangeCallBack<T> = void Function(double value, ValueNotifier<bool> isIndicator);
...
class _RatingBarState extends State<RatingBar> {
                  ...
                  builder: (BuildContext context, double value, Widget child) {
                    return Wrap(
                      ...
                      children: List.generate(
                          widget.starCount, (index) => buildStar(context, index, value, isIndicator)),
                    );
                  },
  ...
  Widget buildStar(BuildContext context, int index, double rating, bool isIndicator) {
    Container container;
    if (index >= rating) {
      //unselected stars
      container = Container(
    ...
    return isIndicator
        ...
        : GestureDetector(
            ...
            onHorizontalDragUpdate: (dragDetails) {
              ...
              double newRating = widget.allowHalfRating ? getHalfRating(_pos.dx) : getFullRating(_pos.dx);
